<%-- 
    ...
    Created on : 9 Jun, 2022, 1:22:17 PM
    Author     : Rishita jain
--%>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="profile.jsp"> <span class="fa fa-edit " ></span> Learn Code <span class="sr-only">(current)</span></a>
      </li>
       ...
       <ul class="navbar-nav mr-right">
             ...
             <li class="nav-item">
              ...
              <li class="nav-item">
                      <a class="nav-link" href="LogoutServlet">  <span class="fa fa-dot-circle-o " ></span> Logout</a>
              </li>
         </ul>
     </div>
</nav>
                    ...
                    <div class="card">
                        <div class="card-header primary-background text-white">
                            ...
                            <div class="card-body">
                                 ...
                                 <img class="card-img-top my-2 py-2 " src="blog_pics/<%= p.getpPic() %>" alt="Card image cap">
                                 ...
                                 <div class="row my-2 row-user">
                                     <div class="col-md-8">
                                         ...
                                         %>
                                         <p class="post-user-info"><a href="#!"> <%= ud.getUserByUserId(p.getuId()).getName() %></a> has posted : </p>
                                     </div>
                                     <div class="col-md-4">
                                ...
                                <div class="card-footer primary-background">
                                    <a href="# !" onclick="doLike( <%= p.getPid() %> , <%= user.getId()%>)" class="btn btn-outline-light btn-lg mx-2"><i class="fa fa-thumbs-up"></i> <span>10</span></a>
  
                                    <a href="# !" class="btn btn-outline-light btn-lg"><i class="fa fa-commenting"></i> <span>10</span></a>
