<%-- 
    Document   : login_page
    Created on : 3 Apr, 2022, 12:57:17 AM
    Author     : Rishita jain
--%>
...
<html>
    ...
    <body>
        ...
        <main class="d-flex align-items-center secondary-background jumbotron" style=" height: 100vh;  padding-bottom: 100px">
            <div class="container">
                <div class="row">
                    <div class="col-md-4 offset-md-4">
                        <div class="card  "  >
                            ...
                            <%
                                    ...
                                    {
                            %>
                            <div class="alert <%= m.getCssClass() %> " roles="alert" >
                                <%=m.getContent() %>
                            ...
                            <div class="card-body">
                                <form action="LoginServlet" method="post">
                                        ...
                                        <button type="submit" class="btn secondary-background text-white">Submit</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
